...
def render_tab(tab):
    if tab == "tab-1":
        Plot1()
        return html.Div([dcc.Graph(id="graph1", figure=fig1, style={"height": 900})])
    if tab == "tab-2":
        Plot2()
        return html.Div([dcc.Graph(id="graph2", figure=fig2, style={"height": 900})])
    if tab == "tab-3":
        Plot4()
        return html.Div([dcc.Graph(id="graph3", figure=fig4, style={"height": 900})])
    if tab == "tab-4":
        Plot5()
        return html.Div([dcc.Graph(id="graph4", figure=fig5, style={"height": 900})])
    if tab == "tab-5":
        return html.Div([])
